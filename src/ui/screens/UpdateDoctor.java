...
public class UpdateDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        updateUserPanel.setBackground(new java.awt.Color(212, 233, 236));
    ...
    private void updateUser() {
        if (index != -1) {
            ...
            resident.setHospitalName(hospitalInput.getText());
            r.set(index, resident);
            FileUtils.writeDoctors(r);
    ...
    private void initImage() {
        ...
        ImagePanel jPanel1 = new ImagePanel("src/assets/updatedoctor.jpg");
