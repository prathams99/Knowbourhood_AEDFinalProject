 ...
 * @author viveksharma
 */
public class DeleteFireman extends javax.swing.JFrame {

    private ArrayList<Fireman> r;
    private int index = -1;
    
    /**
     * Creates new form DeleteFireman
     */
    public DeleteFireman() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Fireman");
        ...
        jLabel15.setText("Delete Firemen");
        ...
        jLabel12.setText("Search Firemen");
    ...
    private void initImage() {
        ...
        ImagePanel jPanel1 = new ImagePanel("src/assets/deletefireman.jpg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteFireman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteFireman().setVisible(true);
            }
        });
    }
