 ...
 * @author jarvis
 */
public class DeleteComm extends javax.swing.JFrame {
    
    private ArrayList<CommunityAdmin> r;
    private int index = -1;

    /**
     * Creates new form DeleteComm
     */
    public DeleteComm() {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Delete Community Admin");
        ...
        jLabel1.setText("Delete Community Admin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteComm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteComm().setVisible(true);
            }
        });
    }
